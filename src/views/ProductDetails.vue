...
<template>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            <div class="slider-box w-full h-full max-lg:mx-auto mx-0">
                                <div class="main-img mb-3 min-[400px]:mb-8">
                                    <img src="../../public/Images/product1.webp" alt="Summer Travel Bag image"
                                        class="max-lg:mx-auto">
                                </div>
                                <div class="grid grid-cols-5 gap-3 max-lg:max-w-[608px] max-lg:mx-auto">
                                    <img src="../../public/Images/short1.webp" alt="Summer Travel Bag image"
                            ...
                            <div class="flex justify-center items-center px-2">
                                <div
                                        ...
                                        <button class="group transition-all duration-500 p-0.5">
                                            <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="" stroke-width="1.6" stroke-miterlimit="10"
                                    ...
                                    <div
                                        class="flex flex-col min-[400px]:flex-row min-[400px]:items-center mb-2 gap-y-3">
                                        ...
                                        <svg class="mx-5 max-[400px]:hidden" xmlns="http://www.w3.org/2000/svg"
                                            width="2" height="36" viewBox="0 0 2 36" fill="none">
    ...
    <div class="mx-auto max-w-7xl bg-white mb-4">
        <!-- <div class="grid grid-cols-5"> -->
        <!-- <div class="col-span-4"> -->
        <section class="py-24 relative">
            <div class="w-full max-w-7xl px-4 md:px-5 lg:px-6 mx-auto">
                <div class="">
                    <h2 class="font-manrope font-bold text-2xl sm:text-4xl leading-10 text-black mb-8 text-center">
                        Customer reviews &
                        rating</h2>
                    <div class="grid grid-cols-12 mb-11">

                        <div class="col-span-12 xl:col-span-4 flex items-center">
                            <div class="box flex flex-col gap-y-2 w-full max-xl:max-w-3xl mx-auto">
                        ...
                        <div class="col-span-12 max-xl:mt-8 xl:col-span-8 xl:pl-8 w-full ">
                            <div
                                ...
                                <div class="col-span-12 md:col-span-8 flex items-center">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h2 class="font-manrope font-bold text-3xl text-black text-center mb-4">4.3
                                            </h2>
                                        ...
                                        <div
                                            ...
                                            <h2 class="font-manrope font-bold text-3xl text-black text-center mb-4">4.8
                                            </h2>
                                            <div class="flex items-center gap-2 mb-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 36 36" fill="none">
                                ...
                                <div class="col-span-12 md:col-span-4 max-lg:mt-8 md:pl-8">
                                    <div class="flex items-center flex-col justify-center w-full h-full ">
                                        <button
                                            class="rounded-full px-5 py-2 bg-indigo-600 font-semibold text-lg text-white whitespace-nowrap mb-6 w-full text-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-400">Write
                                            A Review</button>
                                        <button
                                            class="rounded-full px-5 py-2 bg-white font-semibold text-lg text-indigo-600 whitespace-nowrap w-full text-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-100 hover:shadow-indigo-200">See
                                            All Reviews</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="pb-8 border-b border-gray-200 max-xl:max-w-3xl max-xl:mx-auto">
                        <h4 class="font-manrope font-semibold text-2xl leading-10 text-black mb-6">Most helpful
                            positive
                            review</h4>
                        <div class="flex sm:items-center flex-col sm:flex-row justify-between  mb-4">
                            ...
                            <div class="flex items-center gap-3">
                                <h6 class="font-semibold text-base leading-8 text-black">@john.doe</h6>
                                <p class="font-medium text-sm leading-7 text-gray-400">Nov 01, 2023</p>
                            </div>
                        </div>

                        <p class="font-normal text-base leading-8 text-gray-500 ">
                            ...
                            <div class="flex">
                                ...
                                <div class="relative ">
                                    ...
                                    <div id="dropdown-button" data-target="dropdown"
                                        ...
                                        type="button"><svg class="ml-2" width="12" height="7"
