...
<template>
    ...
    <!-- ../public/Images/product1.webp -->

    <!--start cart section-->
    <section
    class=" relative z-10 after:contents-[''] after:absolute after:z-0 after:h-full xl:after:w-1/3 after:top-0 after:right-0 after:bg-gray-50 my-6">
    <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto relative z-10 bg-white">
        <div class="grid grid-cols-12">
            <div
                class="col-span-12 xl:col-span-8 lg:pr-8 pt-14 pb-8  w-full max-xl:max-w-3xl max-xl:mx-auto">
