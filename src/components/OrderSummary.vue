    ...
    <div class="mt-8">
        ...
        <form>
            ...
            <div class="flex items-center border-b border-gray-200">
                <button
                    class="rounded-full w-full bg-black py-2 px-4 text-white text-sm font-semibold text-center mb-8 transition-all duration-500 hover:bg-black/80">Apply</button>
            </div>
            ...
            <button
                class="w-full text-center bg-indigo-600 rounded-full py-2.5 px-6 font-semibold text-sm text-white transition-all duration-500 hover:bg-indigo-700">Checkout</button>
        </form>
    </div>
</template>
