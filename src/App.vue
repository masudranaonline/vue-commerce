...
<template>
    ...
    <section class="bg-[#294A70]">
        <div class="mx-auto max-w-7xl p-4 md:py-6">
            <div class="grid md:grid-cols-3 gap-4">
                <div class=" md:col-span-2 flex flex-col md:flex-row gap-4 items-center"><img src="../Images/logo.png"
                    ...
                    <div class="text-slate-200 flex flex-col text-start md:text-left"><a
                            ...
                            href="https://anjinmetalindustries.com/">E-khulna.</a>
            ...
            <div class="bg-white p-4 mt-4">
                <ul class="divide-y">
                    <li class="py-1 text-gray-400 hover:text-red-600 hover:bg-gray-200"><a href=""
                            ...
                            <img src="../public/Images/t-shart.png" class="w-5 h-5 border p-0.5 rounded-full"
                                alt="">
    ...
    <div class="mx-auto max-w-7xl my-6">
        <div class="grid grid-cols-2 md:grid-cols-6 hover:bg-gray-200  py-2 rounded-sm hover:shadow-md">
            <div class="flex justify-start items-center space-x-3 border-r-2 border-gray-400 pl-4">
                <img src="../Images/offer1.png" class="h-5 w-5" alt="">
                <p class=" text-sm text-gray-800 font-medium">Safe Payments</p>
            </div>
            <div class="flex justify-start items-center space-x-3 border-r-2 border-gray-400 pl-4">
                <img src="../Images/offer2.png" class="h-5 w-5" alt="">
                <p class=" text-sm text-gray-800 font-medium">Nationwide Delivery</p>
            </div>
            <div class="flex justify-start items-center space-x-3 border-r-2 border-gray-400 pl-4">
                <img src="../Images/offer3.png" class="h-5 w-5" alt="">
                <p class=" text-sm text-gray-800 font-medium">Free & Easy Return</p>
            </div>
            <div class="flex justify-start items-center space-x-3 border-r-2 border-gray-400 pl-4">
                <img src="../Images/offer4.png" class="h-5 w-5" alt="">
                <p class=" text-sm text-gray-800 font-medium">Best Price Guaranteed</p>
            </div>
            <div class="flex justify-start items-center space-x-3 border-r-2 border-gray-400 pl-4">
                <img src="../Images/offer5.png" class="h-5 w-5" alt="">
                <p class=" text-sm text-gray-800 font-medium"> Authentic Products</p>
            </div>
            <div class="flex justify-start items-center space-x-3  pl-4">
                <img src="../Images/offer6.png" class="h-5 w-5" alt="">
                <p class=" text-sm text-gray-800 font-medium">Daraz Verified</p>
            </div>
        </div>
    </div>
    <!--end offer section-->
    ...
    <div class="mx-auto max-w-7xl my-6 py-4 bg-white rounded-md shadow-md px-4">
        <div class="grid grid-cols-2 md:grid-cols-5 divide-x-2">
            <div
                class="col-span-1 flex flex-col items-center  text-gray-800 hover:text-red-700 font-medium cursor-pointer">
                <img class="h-24 w-auto" src="../Images/deliverycar.png" alt="">
                <p class=" text-base pt-2">Free delivery</p>
            </div>

            <div
                class="col-span-1 flex flex-col items-center py-2 text-gray-800 hover:text-red-700 font-medium cursor-pointer">
                <img class="h-24 w-auto" src="../Images/wholesaleprice.png" alt="">
                <p class=" text-base pt-2">Wholesale Price</p>
            </div>

            <div
                class="col-span-1 flex flex-col items-center py-2 text-gray-800 hover:text-red-700 font-medium cursor-pointer">
                <img class="h-24 w-auto" src="../Images/bellow.png" alt="">
                <p class=" text-base pt-2">Everyday Low Price!</p>
            </div>

            <div
                class="col-span-1 flex flex-col items-center py-2 text-gray-800 hover:text-red-700 font-medium cursor-pointer">
                <img class="h-24 w-auto" src="../Images/mart.png" alt="">
                <p class=" text-base pt-2">Mart</p>
            </div>

            <div
                class="col-span-1 flex flex-col items-center py-2 text-gray-800 hover:text-red-700 font-medium cursor-pointer">
                <img class="h-24 w-auto" src="../Images/visacard.png" alt="">
                <p class=" text-base pt-2">Daraz VISA Card</p>
            </div>
        ...
        <div class="bg-white rounded-sm shadow-md px-2 py-8">
            ...
            <div class="grid grid-cols-6 py-4">
                <div class="border">
                    ...
                    <div class="px-2">
                        <h4>Magic Moshari / Mosquito</h4>
                        <div class="flex justify-between">
                            <div class="">
                                <span>৳203</span>
                                <p class="flex justify-start items-center space-x-2"><del>৳55</del><span>-200</span>
                                </p>

                            </div>
                            <div class="">
                                <button class="text-sm space-x-2 border px-2 py-1">
                                    Add to cart
                                </button>
                            </div>
                        </div>
